<%-- 
    Document   : RegisterBoxing
    Created on : Apr 13, 2022, 3:13:28 AM
    Author     : Matrix
--%>
...
</select> </div><div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label px-3">Schedule<span class="text-danger"> *</span></label> <input type="datetime-local" class="datepicker" name="date" id="txtBegin" value="2022-04-25T19:24" required/> </div>
                    </div>
