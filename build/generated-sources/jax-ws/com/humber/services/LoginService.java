 ...
 * 
 */
@WebServiceClient(name = "LoginService", targetNamespace = "http://services.humber.com/", wsdlLocation = "http://localhost:8899/project/LoginService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName LOGINSERVICE_QNAME = new QName("http://services.humber.com/", "LoginService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8899/project/LoginService?WSDL");
    ...
    public ILogin getLoginPort() {
        return super.getPort(new QName("http://services.humber.com/", "LoginPort"), ILogin.class);
    }
     ...
     */
    @WebEndpoint(name = "LoginPort")
    public ILogin getLoginPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.humber.com/", "LoginPort"), ILogin.class, features);
    }
